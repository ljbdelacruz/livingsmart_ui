...
class CardItem1Widget extends StatelessWidget {
  final CardItem1WidgetVM vm;
  final NormalCallback dismiss;
  final NormalCallback click;
  CardItem1Widget(this.vm, this.dismiss, this.click);
...
class CardItem1WidgetVM{
  ...
  Color bgColor;
  String loadingGif;
  CardItem1WidgetVM(this.tag, this.id, {this.image = "", this.quantity = 1, this.name="", this.bgColor = Colors.blue, this.loadingGif = ""});
